export function ContactoHero() {
  return (
    <section
      className="relative isolate overflow-hidden text-center pt-[160px] pb-12 lg:pb-16"
      style={{
    ...
    >
      ...
      <div className="container-page relative">
        <span className="pill-cyan-dark">Hablemos</span>
        <h1 className="mt-8 mx-auto max-w-[920px] font-heading font-black text-white text-[clamp(40px,7vw,80px)] leading-[1.05] tracking-[-0.02em]">
          ¿Listo para el
          <br />
          <span className="text-gradient-brand inline-block">Cambio?</span>
        </h1>
        <p className="mt-8 mx-auto max-w-[680px] text-[#cfeaf3]/80 text-[clamp(16px,1.6vw,20px)] leading-relaxed">
          Agenda una demo gratuita y descubre cómo transformar tu consumo de
          agua.
        </p>
      </div>
    </section>
